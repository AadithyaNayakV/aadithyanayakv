...
export default function About() {
  ...
  return (
    <section id="about" ref={scope} className="relative z-10 py-24 md:py-32">
      <div className="shell">
        {/* Clean White/Neutral Glass Container for About section */}
        <div className="relative rounded-3xl border border-edge bg-surface/85 p-7 md:p-12 shadow-xs overflow-hidden">
          <SectionHeading
            title="About Me"
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-12 items-start">
            ...
            <div data-wipe className="lg:col-span-4 space-y-4">
              ...
              <SpotlightCard
                ...
                className="group p-5 bg-surface border border-edge"
              >
                <a href="#education" className="block">
                  <div className="flex items-center gap-3">
                    <div className="grid size-10 place-items-center rounded-xl border border-edge bg-surface text-ink transition-transform duration-200 group-hover:scale-105 shadow-2xs">
                      <GraduationCap className="size-5" />
                    </div>
                    <div>
                      <h3 className="font-display text-base font-semibold text-ink transition-colors group-hover:text-signal">
              ...
              {leetcode ? (
                <SpotlightCard
                  spotlightColor="rgba(34, 211, 238, 0.12)"
                  borderColor="rgba(34, 211, 238, 0.4)"
                  className="group bg-surface border border-edge"
                >
                  <a
                    href="#leetcode"
